<%@page import="com.weixin.util.RedisHelper"%>
...
<%!  
    ...
    private String generateCheckCode(HttpServletRequest request) { 
        ...
        RedisHelper.getInstance().setValue("MobilePhone_"+MobilePhone, String.valueOf(result));
        RedisHelper.getInstance().expire("MobilePhone_"+MobilePhone,300);
        return checkCode;  
    }
    %>  
    <%
