...
<html>
  <head>
	...
	<script src="js/binding.js?time=20171113"></script>
  ...
  <body>
   <input type="hidden" id="OpenID" value="${ OpenID}">
    ...
    <input type="hidden" id="basePath" value="<%=basePath%>">
     <%--   绑定页面 ${OpenID}<br>
        <p class="f-marTop30"><input id="telephone" type="text" placeholder="请输入手机号码"/></p>
       <p class="f-marTop30"><input id="authcode" class="f-w40" type="text" placeholder="输入验证码"/><button class="btn btn-getCode">获取验证码</button></p>
    <button onclick="bindWeChatAccount()">绑定</button>
    
    <a href="user/toRegister?OpenID=${OpenID}">去注册</a> --%>
	...
	<div class="weui_btn_link"><a><span>账号注册</span></a></div> 
